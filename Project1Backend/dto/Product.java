...
private List<Sell_product> sellList=new ArrayList<Sell_product>(0);

public List<Sell_product> getSellList() {
	return sellList;
}
public void setSellList(List<Sell_product> sellList) {
...
public String toString() {
	return "Product [product_id=" + product_id + ", product_name=" + product_name + ", product_available_quantity="
			+ product_available_quantity + ", product_unit_price=" + product_unit_price + ", enable=" + enable
			+ ", sellList=" + sellList + "]";
}
}
